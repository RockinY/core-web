...
export const Glyph = ({ glyph }: GlyphProps) => {
  switch (glyph) {
    ...
    case 'link':
      return (
        <g>
          <path d='M11.56,25a4.62,4.62,0,0,1-3.19-7.86l2.39-2.39,1.59,1.59L10,18.73a2.26,2.26,0,1,0,3.19,3.19l3.19-3.19A2.22,2.22,0,0,0,17,17.14a2.76,2.76,0,0,0-.57-1.6L15.2,14.41l1.6-1.6,1.25,1.25a4.47,4.47,0,0,1,1.25,3.19,4.12,4.12,0,0,1-1.36,3.19l-3.19,3.19A4.32,4.32,0,0,1,11.56,25Zm3.64-5.81L14,18.05a4.54,4.54,0,0,1,0-6.49l3.19-3.19a4.59,4.59,0,0,1,6.49,6.49l-2.39,2.39-1.59-1.59L22,13.27a2.26,2.26,0,0,0-3.19-3.19l-3.31,3.07a2.21,2.21,0,0,0,0,3.19l1.26,1.25Z' />
        </g>
      )
    case 'cancel':
      return (
        <g>
          <path d='M24.78,10.49,19.3,16l5.48,5.48a.6.6,0,0,1,0,.84l-2.49,2.49a.59.59,0,0,1-.83,0L16,19.35l-5.44,5.48a.59.59,0,0,1-.83,0l-2.5-2.49a.62.62,0,0,1,0-.84L12.66,16,7.21,10.58a.6.6,0,0,1,0-.83l2.5-2.49a.59.59,0,0,1,.83,0L16,12.69l5.49-5.52a.59.59,0,0,1,.83,0l2.5,2.49A.59.59,0,0,1,24.78,10.49Z' />
        </g>
      )
    case 'ok':
      return (
